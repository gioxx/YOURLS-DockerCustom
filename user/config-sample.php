 ...
 ** To use an IDN domain (eg https://example.com), write its ascii form here (eg https://xn--hh-bjab.com) */
...
// Uncomment one of the following lines to force a specific translation:
